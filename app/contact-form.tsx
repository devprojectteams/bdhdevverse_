...
export function ContactForm() {
  ...
  return (
    <section className="px-8 py-16 bg-gradient-to-r from-blue-500 to-purple-500">
      ...
      <div className="container mx-auto border border-gray-200 bg-white shadow-lg">
        <div className="grid grid-cols-1 lg:grid-cols-7 md:gap-10 p-5">
          <div className="w-full col-span-3 rounded-lg h-full py-8 px-5 bg-blue-800 text-white">
          ...
          <div className="w-full mt-8 md:mt-0 md:px-10 col-span-4 h-full">
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-8">
                {[
                  "App Development/Project Dev. Outsourcing",
                  "Recruitment/Talent Mgt.",
              ...
              <div className="w-full flex justify-end">
                <button
                  type="submit"
                  className="px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  Send Message
                </button>
              </div>
